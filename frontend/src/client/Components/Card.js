...
const Card = (props) => {
  ...
  return (
    <div
      className="card d-flex gap-1 flex-column rounded-4 p-3 shadow mx-3 my-3 position-relative"
      style={{ width: props.width, minWidth: "250px", height: props.height }}
      id={props.id}
      onClick={() => {
    ...
    >
      ...
      <div
        className="card__course__price align-self-end fw-bold position-absolute"
        style={{ bottom: "10px" }}
      >
        ${props.price}
      </div>
